...
module.exports = new function() {
    ...
    this._fetchFirstImage = function(guid, i) {
        ...
        .then(function(candyAssets) {
            //console.log(i);
temp = temp + 1;
console.log("got candy assets",i);
if (i == 17 ) {
    console.log('-17-', candyAssets);
}
if (i == 18 ) {
    console.log('-18-', candyAssets);
}
if (i == 19 ) {
    console.log('-19-', candyAssets);
}
            //console.log("in fetch first image", candyAssets);
            ...
            //if (candyAssets.results.length) {
                ...
                console.log( "im in the out vit but i should be 5", i)
                var returnObject = {
                    'src' : 'holdingimage',
                    'i' : i
                }
